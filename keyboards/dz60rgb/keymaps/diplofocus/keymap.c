...
#define MOUSEFN LT(1, KC_CAPS)
#define SFTSLSH RSFT_T(KC_SLSH)
#define LY2DEL  LT(2, KC_DEL)
#define PGDWN KC_PGDOWN
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        MOUSEFN, /**/ KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  \
		    KC_LSFT, /**/ KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  SFTSLSH, KC_UP,   LY2DEL,  \
		    KC_LCTL, /**/ KC_LGUI, KC_LALT,                   KC_SPC,                    KC_RALT, MO(1)  , KC_LEFT, KC_DOWN, KC_RIGHT),

		[_LAYER1] = LAYOUT( /* MOUSE LAYER */
        TO(3),   /**/ KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL ,\
        _______, /**/ KC_BTN2, KC_MS_U, KC_BTN1, _______, _______, KC_CALC, _______, KC_INS,  _______, KC_PSCR, KC_SLCK, KC_PAUS, RESET  , \
        _______, /**/ KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, _______, \
        _______, /**/ KC_ACL1, KC_ACL2, KC_WH_L, KC_WH_R, _______, _______, _______, _______, KC_END,  PGDWN,   KC_VOLU, KC_MUTE, \
        _______, /**/ _______, KC_ACL0,                   KC_WH_D,                   _______, _______, KC_MPRV, KC_VOLD, KC_MNXT),
